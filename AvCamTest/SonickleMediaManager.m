...
@implementation SonickleMediaManager
{
...
{
    NSLog(@"SonickleMediaManager: stopping auido record");
    [audioRecorder stop];
...
{
    NSLog(@"SonickleMediaManager: auido convert is done");
